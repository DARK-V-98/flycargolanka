      ...
      <Card className="max-w-4xl mx-auto">
        ...
        <CardContent className="space-y-6 text-foreground/90">
          ...
          <section>
            ...
            <p>
              For any questions about our Return & Refund Policy, please contact us at <a href="mailto:info@flycargolanka.lk" className="text-primary underline">info@flycargolanka.lk</a> or call us on our hotline.
            </p>
          </section>
        </CardContent>
      </Card>
